  ...
  return (
    <div className="hidden md:block fixed bottom-6 right-6 z-50 group">
      <button
        ...
        aria-label={tooltip}
        title={tooltip}
        className="h-8 w-8 rounded-full border border-slate-300/80 bg-slate-100/70 text-slate-700 shadow-md backdrop-blur-sm transition hover:bg-slate-200/80 dark:border-slate-700/80 dark:bg-slate-900/60 dark:text-slate-200 dark:hover:bg-slate-800/80 flex items-center justify-center"
      >
